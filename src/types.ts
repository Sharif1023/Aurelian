...
export const PRODUCTS: Product[] = [
  {
    ...
    description: 'A timeless classic. This Oxford shirt is crafted from premium cotton for a crisp, clean look. **100% Organic Cotton** for all-day comfort.',
    rating: 5,
    reviews: 124,
    stock: 42,
    status: 'Active',
  ...
  },
  {
    ...
    description: 'The perfect foundation for any outfit. Our essential tee features a tailored fit and ultra-soft fabric. **Supima Cotton** for superior softness.',
    rating: 4.5,
    reviews: 89,
    stock: 15,
    status: 'Active',
  ...
  },
  {
    ...
    price: 95,
    category: 'Pant',
    image: 'https://images.unsplash.com/photo-1624371414361-e6e8ea04c112?q=80&w=1974&auto=format&fit=crop',
    description: 'Versatile and comfortable. These slim-fit chinos are perfect for both casual and semi-formal occasions. **Stretch Twill** for ease of movement.',
    rating: 5,
    reviews: 56,
    stock: 28,
    status: 'Active',
  ...
  },
  {
    ...
    description: 'Elegant craftsmanship. These leather Derby shoes are handcrafted for a sophisticated finish. **Full-Grain Leather** with a durable sole.',
    rating: 5,
    reviews: 42,
    stock: 8,
    status: 'Active',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1624222247344-550fbadcd973?q=80&w=2070&auto=format&fit=crop',
    description: 'The perfect finishing touch. A sleek, minimalist belt made from genuine leather. **Vegetable-Tanned Leather** for a natural patina.',
    rating: 4,
    reviews: 210,
    stock: 12,
    status: 'Active',
  ...
  },
  {
    ...
    description: 'Stay cool and stylish. This linen shirt is lightweight and breathable, ideal for warm weather. **100% Pure Linen** for natural texture.',
    rating: 5,
    reviews: 78,
    stock: 24,
    status: 'Active',
  ...
  },
  {
    ...
    description: 'The ultimate essential pack. Includes one Oxford Cotton Shirt and one Slim Fit Chino. **Save 20%** with this exclusive combo offer.',
    rating: 5,
    reviews: 45,
    stock: 20,
    status: 'Active',
